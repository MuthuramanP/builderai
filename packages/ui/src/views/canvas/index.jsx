...
// const
import { BUILDERAI_CREDENTIAL_ID } from '@/store/constant'
    ...
    const handleSaveFlow = async (chatflowName) => {
        if (reactFlowInstance) {
            const nodes = reactFlowInstance.getNodes().map((node) => {
                ...
                if (Object.prototype.hasOwnProperty.call(nodeData.inputs, BUILDERAI_CREDENTIAL_ID)) {
                    nodeData.credential = nodeData.inputs[BUILDERAI_CREDENTIAL_ID]
                    nodeData.inputs = omit(nodeData.inputs, [BUILDERAI_CREDENTIAL_ID])
                }
                node.data = {
                    ...nodeData,
                    selected: false
