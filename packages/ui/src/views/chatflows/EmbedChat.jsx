...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://builder.dev.nusummituat.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
    ...
    chatWindow: {
        ...
        footer: {
            ...
            text: 'Powered by',
            company: 'NuAgentOne',
            companyLink: 'https://builderai.com'
        }
    }
}
